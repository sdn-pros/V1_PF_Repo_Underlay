...
| 192.52.75.2 | Inherited from peer group ISP-3 | default | - | - | - | Allowed, allowed 6 times | - | - | - | - | - |
| 192.52.81.2 | Inherited from peer group CORE | default | - | - | - | Allowed, allowed 6 times | - | - | - | - | - |
| 192.52.82.2 | Inherited from peer group CORE | default | - | - | - | Allowed, allowed 6 times | - | - | - | - | - |
...
router bgp 65000
   ...
   neighbor 192.52.75.2 allowas-in 6
   neighbor 192.52.81.2 peer group CORE
   neighbor 192.52.81.2 allowas-in 6
   neighbor 192.52.82.2 peer group CORE
   neighbor 192.52.82.2 allowas-in 6
   !
   address-family ipv4
