...
| 192.53.75.2 | Inherited from peer group ISP-3 | default | - | - | - | Allowed, allowed 6 times | - | - | - | - | - |
| 192.53.83.2 | Inherited from peer group CORE | default | - | - | - | Allowed, allowed 6 times | - | - | - | - | - |
| 192.53.84.2 | Inherited from peer group CORE | default | - | - | - | Allowed, allowed 6 times | - | - | - | - | - |
...
router bgp 65000
   ...
   neighbor 192.53.75.2 allowas-in 6
   neighbor 192.53.83.2 peer group CORE
   neighbor 192.53.83.2 allowas-in 6
   neighbor 192.53.84.2 peer group CORE
   neighbor 192.53.84.2 allowas-in 6
   !
   address-family ipv4
